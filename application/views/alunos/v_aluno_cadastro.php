			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body">
						...
						<div class="box-body">
							<!-- conteudo -->
                         <form  id="cadastro"  method="post" enctype="multipart/form-data" action="<?php echo base_url();?>alunos/adicionar" acceptcharset="UTF-8" >
                                                ...
                                                <div class="form-group ">
                                                 ...
                                                 <div class="form-group ">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input required="" class="form-control" id="cdaluno_cpf" name="cdaluno_cpf" placeholder="0000000000000" type="text"/>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
        ...
        defaultDate: new Date() 
           ...
           $("#cadastro").validate({
              ...
              submitHandler: function( form ){
                 ...
                 $.ajax({
                        url: '<?php echo base_url();?>alunos/adicionar', // point to server-side controller method
