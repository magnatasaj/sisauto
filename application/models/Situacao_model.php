...
class Situacao_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('id_sitaucao', $q);
	$this->db->or_like('situacao_nome', $q);
	$this->db->or_like('situacao_obs', $q);
...
/* Location: ./application/models/Situacao_model.php */
